...
const ExploreMenu = ({category,setCategory}) => {
  return (
    <div className='explore-menu' id='explore-menu'>
        ...
        <p className='explore-menu-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus eaque asperiores dignissimos numquam. Fugit provident soluta earum quos culpa commodi enim ipsum corporis fuga reiciendis?</p>
